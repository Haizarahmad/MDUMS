    ...
    <div class="container-1">
        <div class="box-1">
            ...
            <table id="example" class="table table-striped nowrap" style="width:100%">
                ...
                <?php
                        include('config.php');
                        $query = mysqli_query($conn, "SELECT * FROM expense WHERE Expense_status = 'accepted' ORDER BY Expense_Date DESC");
                ...
                <tr>
                    ...
                    <td>Permohonan Baucar resit anda telah diterima (No. baucar: <?php echo $row['Expense_id']; ?>)</td>
                    <td>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $row['Expense_id'];?>"><i class="fa-regular fa-eye mr-1"></i>Lihat</button>
                        <a href="print.php?Expense_id=<?php echo $row['Expense_id'];?>" target="_blank" class="btn btn-primary"><i class="fa-solid fa-print mr-1"></i>Cetak</a>
                    </td>
