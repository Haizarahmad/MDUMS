...
<body>
    ...
    if (isset($_POST["add"])) {
        ...
        $sql = "INSERT INTO permanentresident(application_name, application_status, application_age, application_religion, application_marital, application_address, application_phonenumber, application_email, application_date) 
        VALUES ('$name','$status','$age','$nation','$marital','$address','$phonenumber','$email','$date')";
    ...
    <div class="container-1">
        ...
        <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
            <div class="toast">
                ...
                <p>Data ahli kariah sudah ditambah ke dalam sistem</p>
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="col">
            <label>Umur</label>
            <input type="text" name="age" class="form-control" placeholder="Masukkan Umur">
            </div>
            <div class="col">
            ...
            <div class="col">
            <label>E-mel</label>
            <input type="text" name="email" class="form-control" placeholder="Masukkan E-mel">
            </div>
            <div class="col">
            <label>Telefon</label>
            <input type="text" name="phone" class="form-control" placeholder="Masukkan Nombor Telefon">
            </div>
            <div class="col">
            <label>Alamat</label>
            <input type="text" name="address" class="form-control" placeholder="Masukkan Alamat Rumah">
            </div>
